...
class AgentResponse(BaseModel):
    ...
    name: str = Field(..., description="Agent name (hyphen-case)")# 代理名称
    description: str = Field(default="", description="Agent description")# 代理描述
    model: str | None = Field(default=None, description="Optional model override")# 可选模型覆盖
    tool_groups: list[str] | None = Field(default=None, description="Optional tool group whitelist")# 可选工具组白名单
    soul: str | None = Field(default=None, description="SOUL.md content (included on GET /{name})")# SOUL.md 内容（包含在 GET /{name} 中）
